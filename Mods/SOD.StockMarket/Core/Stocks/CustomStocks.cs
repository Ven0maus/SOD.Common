namespace SOD.StockMarket.Core.Stocks
{
    ...
    internal static class CustomStocks
    {
        ...
        {
            // Mega-corporations
            (new CompanyData("Starch Kola", 0.4d), (decimal)MathHelper.Random.NextDouble(5000f, 10000f)),
            (new CompanyData("Kaizen", 0.3d), (decimal)MathHelper.Random.NextDouble(2000f, 5000f)),

            // Currencies
            (new CompanyData("Crow", 0.05d), (decimal)MathHelper.Random.NextDouble(0.975f, 1.025f))
        };
    }
}
