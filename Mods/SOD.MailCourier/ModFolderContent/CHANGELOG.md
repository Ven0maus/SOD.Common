...
- When equipping a sealed mail the route to it will be plotted (if no route is currently plotted, unless its another mail)
(both these 2 can be enforced to always overwrite, through the config options)
